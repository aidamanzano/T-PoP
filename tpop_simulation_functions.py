...
def parser(simulation_number, probability_of_lying, probability_of_coerced, density, accuracy, True_Positive, True_Negative, False_Positive, False_Negative):
    ...
    row_list = [simulation_number, probability_of_lying, probability_of_coerced, density, accuracy, 
